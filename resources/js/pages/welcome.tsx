            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950">
                ...
                <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32">
                    ...
                    <div className="absolute inset-0 -z-10">
                        ...
                        <div className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-teal-200/40 blur-3xl dark:bg-teal-900/20" />
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
                                Track your income, expenses, and investments in one beautiful place.
                                Make smarter financial decisions with powerful insights and reports.
                            </p>
                            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                                <Link
                                    href={auth.user ? dashboard() : register()}
                                    className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 px-8 py-3.5 text-base font-semibold text-white shadow-xl shadow-emerald-500/25 transition-all hover:shadow-2xl hover:shadow-emerald-500/30 hover:-translate-y-0.5"
                                >
                            ...
                            {[
                                {
                                    ...
                                    description: 'Track all your bank accounts in one place with real-time balances.',
                                    color: 'from-blue-500 to-cyan-500',
                                },
                                {
                                    icon: CreditCard,
                                    title: 'Card Management',
                                    description: 'Manage debit and credit cards with payment tracking and due dates.',
                                    color: 'from-purple-500 to-pink-500',
                                },
                                {
                                    icon: BarChart3,
                                    title: 'Transaction Journal',
                                    description: 'Every transaction logged and categorized for complete visibility.',
                                    color: 'from-emerald-500 to-teal-500',
                                },
                                {
                                    icon: TrendingUp,
                                    title: 'Smart Categories',
                                    description: 'Organize with hierarchical categories and subcategories.',
                                    color: 'from-orange-500 to-amber-500',
                                },
                                {
                                    icon: PiggyBank,
                                    title: 'Expense Tracking',
                                    description: 'Track where your money goes with merchant and vendor management.',
                                    color: 'from-rose-500 to-red-500',
                                },
                                {
                                    icon: Shield,
                                    title: 'Secure & Private',
                                    description: 'Your financial data stays safe with enterprise-grade security.',
                                    color: 'from-slate-500 to-slate-700',
                                },
                            ].map((feature, index) => (
                                <div
                                    key={index}
                                    className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1 dark:border-slate-800 dark:bg-slate-900"
                                >
                                    <div
                ...
                <section className="py-20 lg:py-32">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-16 text-center shadow-2xl sm:px-16 lg:py-24">
                            <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.3)_1px,transparent_0)] bg-[size:24px_24px]" />
                            <div className="relative">
                                <h2 className="text-3xl font-bold text-white sm:text-4xl">
                                    Ready to take control?
                                </h2>
                                <p className="mx-auto mt-4 max-w-2xl text-lg text-emerald-100">
                                    Start tracking your finances today. It's free, simple, and powerful.
                                </p>
                                <div className="mt-8">
                                    <Link
                                        href={auth.user ? dashboard() : register()}
                                        className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-base font-semibold text-emerald-600 shadow-xl transition-all hover:shadow-2xl hover:-translate-y-0.5"
                                    >
