...
export default function BudgetEdit({ budgetId }: { budgetId: number }) {
    ...
    const fetchData = async () => {
        try {
            ...
            const budget: Budget = budgetRes.data.data;
