                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Configure the behavior and monitor usage of your
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="ai_model">Gemini Model</Label>
                                <Select
                                    value={aiModel}
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Newer models may be smarter but might have
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Define the AI's personality and any specific
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Tell the AI about yourself so it can provide
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    These are the mandatory rules the AI must
                                    follow to function correctly within the app.
                                    They are appended to your custom
                                    instructions.
                                </p>
                            </div>
